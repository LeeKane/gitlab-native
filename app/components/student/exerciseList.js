...
export default class ExcriseList extends Component{
  constructor(props)
  {
    super(props);
    this.state = {
  ...
  componentWillReceiveProps(props){
    ...
    this.setState({
           dataSource: dataSource.cloneWithRows(repoList.exercises.data),
           indicator:false
    })
  }
  renderRow = (exam)=>
...
render(){
  ...
  <View style={styles.container}>
      ...
      <Toolbar style={styles.navBar} title={'Exercise'} onIconPress={drawer.openDrawer} />
      </View>
    {indicator &&
